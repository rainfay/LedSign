//Jason Archip
//proof of concept printing to /dev/tty*
#include <stdio.h> 
#include <stdlib.h>
...
start('Z','0');
fprintf(fp,"%c0b Hello there signtest.c %c Testing a C program, applying the knowlage that in learned in class now if I could send this directly from the program %c",smf,time,end);
